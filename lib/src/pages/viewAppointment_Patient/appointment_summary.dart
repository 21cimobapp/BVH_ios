...
//                          appt.data["departmentName"].toUpperCase(), //underapi
            ...
            appointmentStatus(), // Added by Vrushali for appointment status.
            _buildBottomIcon()
          ],
        ),
      ),
...
// Added by Vrushali for appointment status.
...
//      } else if (appt.data["appointmentStatus"] == "CANCELLED") {//underapi
  ...
  Widget viewPendingAppointment() {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
      Text("Appointment Pending", style: statusStyle),
    ]);
  }
  ...
  Widget viewCancelledAppointment() {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
      Text("Appointment Cancelled", style: statusStyle),
    ]);
  }
  ...
  Widget viewNoShowAppointment() {
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
      Text("Appointment not attended", style: statusStyle),
    ]);
  }

// End Added by Vrushali for appointment status.
...
//              Text("Appointment Number : ${appt.data["appointmentNumber"]}",//underapi
        ...
        mainAxisAlignment: MainAxisAlignment.end, // changed 19th march
          children: [
            Text(
