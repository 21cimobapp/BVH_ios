...
class _IndexNewState extends State<IndexNew> {
  ...
  void initState() {
    super.initState();
    _navBarItems = [
      NavBarItemData("Home", OMIcons.home, 150, Colors.orange[300]),
      NavBarItemData("Appointments", OMIcons.bookmarks, 150, Color(0xff594ccf)),
      NavBarItemData("Doctors", OMIcons.person, 150, Color(0xff09a8d9)),
    ...
    _viewsByIndex = <Widget>[
      HomePagePatientNew(appointmentNumber:widget.appointmentNumber),
      ViewAppointment(),
